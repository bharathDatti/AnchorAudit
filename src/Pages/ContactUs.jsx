...
const ContactUs = () => {
  return (
    <section className="bg-gradient-to-r from-black to-[#2D3436] font-Parkinsans text-white ">
      <div className="">
        <div className=" min-h-screen flex flex-col items-center py-10">
          <div className="container mx-auto px-4 lg:px-20">
            <h1 className="text-4xl font-semibold text-center p-7 text-white mb-6">
              Contact Us
            </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                <form className="bg-white bg-opacity-70 p-6 rounded-lg shadow-lg">
                  ...
                  <div className="mb-4">
                    <label
                      htmlFor="message"
                      className="block  text-black text-sm font-medium 0"
                    >
                      Your Message
                    </label>
                    <textarea
                  ...
                  <NavLink  className="group/button relative inline-flex items-center justify-center overflow-hidden rounded-md bg-blue-800 backdrop-blur-lg px-6 py-2 text-base font-semibold text-white transition-all duration-300 ease-in-out hover:scale-110 hover:shadow-xl hover:shadow-blue-600/50 border border-white/20">
              ...
              {/* Contact Information */}
              <div className="space-y-8 bg-white text-black p-5 bg-opacity-50">
                <div>
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-gray-800 text-white mb-2">
                    Phone
                  </h2>
                ...
                <div>
                  ...
                  <div className="flex items-center  gap-4">
                    <div className="social-button">
                      <NavLink class="relative w-12 h-12 rounded-full ">
                        <div className="floater w-full h-full absolute top-0 left-0 bg- rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                    ...
                    <div className="social-button">
                      <NavLink className="relative w-12 h-12 rounded-full group">
                        ...
                        <div className="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-black rounded-full">
                          <svg
                            ...
                            width="24"
                            viewBox="0 0 24 24"
                            xmlns="https://github.com/bharathDatti"
                          >
                            <path
                              className="group-hover:fill-[#171543] fill-white duration-300"
