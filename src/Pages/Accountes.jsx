...
import ResultList from '../componenets/ResultList';  
...
<div className="flex-col gap-4 w-full flex items-center justify-center">
  ...
  return (
    <>
      <div className="p-20 bg-gradient-to-r from-black to-[#2D3436] text-white font-Parkinsans">
        <p className="text-center text-6xl font-medium py-">CHARTERED <br/>ACCOUNTANTS</p>
