        ...
        >
          ...
          <div className="flex items-center justify-center py-6">
            <NavLink
              ...
              className="cursor-pointer bg-gradient-to-b from-indigo-500 to-indigo-600 shadow-[0px_4px_32px_0_rgba(99,102,241,.70)] px-8 py-2 rounded-xl border-[1px] border-slate-500 text-white font-medium group"
            >
